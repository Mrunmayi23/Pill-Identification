...
def image_classifier(input_img):
        ...
        def clustering(pixels,h,w):
            ...
            f = open(r"C:\Users\HP\Desktop\Final Year Project\pill_recognition\helper_files\color.txt", "r")
            ...
            for color in colors:
                f2 = open('pill_recognition/helper_files/' + color + ".txt", "r")
        ...
        imprints = [re.sub(r'[^a-zA-Z0-9\s]', '', text.strip()) for _, text, _ in result if text.strip()]
        imprints_without_spaces = ''.join(imprints).strip()
        ...
        shapes = ['bullet', 'capsule','capsule1', 'diamond', 'double-circle', 'freeform', 'hexagon', 'octagon', 'oval', 'pentagon',
                'rectangle', 'round', 'semi-circle', 'square', 'tear', 'trapezoid', 'triangle']
        groups = [['capsule','capsule1', 'diamond', 'double-circle', 'oval', 'tear', 'trapezoid'], ['hexagon', 'pentagon', 'round', 'semi-circle', 'square', 'trapezoid', 'triangle'], ['octagon', 'rectangle', 'semi-circle'], ['freeform'], ['bullet']]
        probability = {'round': 2032, 'oval': 1476, 'capsule': 738, 'capsule1':738, 'triangle': 30, 'rectangle': 27, 'diamond': 16, 'pentagon': 15, 'tear': 13, 'hexagon': 12, 'square': 12, 'bullet': 6, 'semi-circle': 5, 'trapezoid': 3, 'freeform': 2, 'octagon': 2, 'double-circle': 3}
        ...
        # Example: Extract text from all paragraphs
            ...
            text_paragraphs = soup.find_all('dl', class_= "pid-list")
